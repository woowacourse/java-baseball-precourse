...
---
- 서로 다른 수로 이루어진 세자리 수 입력 받기
- 예외 상황 : IllegalArgumentException 발생 -> 종료
  - [ ] : 3자리가 아닌 경우.
  - [ ] : 숫자 중 0이 들어있는 경우.
  - [ ] : 숫자가 아닌 경우.
  - [ ] : 중복된 숫자를 입력 할 경우.
...
---
- 1부터 9까지 서로 다른 수로 이루어진 3자리 수 생성 := 난수 생성 중복 불가
 

## 3. 판정 기능

---
- 숫자만 일치하고 다른 자리에 있을 경우 := 볼
- 자리와 숫자 일치 := 스트라이크
- 숫자가 전혀 일치하지 않는다면 := 낫싱

## 4. 게임 종료 후 사용자 응답에 대한 재시작 기능 (사용자 입력)
