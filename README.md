...
## 🎯 구현할 기능 목록
- 1에서 9까지 서로 다른 임의의 수 3개 생성하기
- 플레이어로부터 3자리수 입력받기
- 플레이어가 입력한 3자리수가 유효한지 판단하기
- 프로그램이 생성한 임의의 수와 플레이어가 입력한 3자리수 비교하기
- 비교한 결과를 볼, 스트라이크 갯수로 표시하여 출력하기
- 게임 종료 후, 플레이어로부터 재시작/종료를 구분하는 수 (1 또는 2) 입력받기
- 플레이어가 입력한 재시작/종료를 구분하는 수가 유효한지 판단하기
- 게임 재시작 또는 종료하기
