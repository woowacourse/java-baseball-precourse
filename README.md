...
## :computer: 구현 기능 목록 (taehee-kim-dev)
1. 사용자로부터 숫자를 입력받고, 해당 숫자를 그대로 콘솔에 출력하는 기능을 만든다. <br>
(일단 정수 999를 입력하면 프로그램이 종료되도록 한다. <br>
또한, 세 자리 정수가 아닌 다른 모든 입력에 대해서는 IllegalArgumentException을 발생시킨다.)
1. RandomUtils를 사용해 컴퓨터의 랜덤 3자리 정수를 만들어내는 기능을 만든다.
