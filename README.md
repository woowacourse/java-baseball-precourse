...
#### 6. 정답을 맞힌다면 정답 메세지가 출력된다.

- 성공 메세지 출력

#### 7. Player는 게임을 다시 시작할 것인지 선택한다.
...
- 1~9로 사이의 중복되지 않은 숫자 3자리를 입력해야 한다.
...
- IllegalArgumentException가 발생되면 어플리케이션을 종료한다.
