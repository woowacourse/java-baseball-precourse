...
### 구현할 기능
> Application : 사용자가 입력한 값이 유효한지 검사, 입력한 문자열을 리스트로 변환
- [x] [예외] 입력한 문자가 숫자인지 검사
- [x] 사용자 입력을 숫자 리스트로 변환
> Game : 임의의 수를 가진 컴퓨터 생성, 힌트로 게임의 종료 여부 결정
- [x] 게임이 생성되면 임의의 수를 가진 컴퓨터 생성
- [x] Hint 객체를 받아 사용자가 정답을 맞췄는지 확인
- [x] 사용자 입력으로 게임 진행 결정
...
> Hint : 2개의 Balls를 비교해 스트라이크, 볼, 낫싱의 개수를 저장하는 객체
...
- 미션은 **기능 요구사항, 프로그래밍 요구사항, 제 진행 요구사항** 세 가지로 구성되어 있다.
