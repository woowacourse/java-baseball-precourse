...
## 🔧 구현할 기능 목록
- 플레이어의 서로 다른 3자리 숫자 입력
- 상대방(컴퓨터)의 서로 다른 3자리 숫자 생성
- 플레이어와 상대방의 각 숫자가 중복되는지 체크
- 위치까지 중복되는지 체크
- 3자리 숫자가 모두 일치하지 않는다면 힌트 제공
- 위의 과정에서 두번째만 제외하고 반복
- 3자리 숫자가 모두 일치하면 게임 종료
- 게임을 다시 할지, 완전히 종료할지 선택
- 다시 한다면 위 과정 반복
