...
## 📝 구현할 기능 목록
1. 서로 다른 임의의 숫자(1부터 9 사이) 3개를 생성하는 기능
2. 스트라이크3이 될때까지 계속 입력을 받는 기능
3. 특정 문자열이 3자리 수인지 확인하는 기능 (아닌 경우 IllegalArgumentException 발생)
4. 특정 문자열이 1 또는 2인지 확인하는 기능 (아닌 경우 IllegalArgumentException 발생)
5. 두개의 3자리 숫자를 비교해서 볼, 스트라이크의 개수를 카운트하는 기능
6. 카운트한 결과를 출력하는 기능
7. 정답을 맞췄을 때 게임 종료여부를 묻는 입력을 받는 기능
