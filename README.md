...
- [x] 게임 정답을 생성한다.
    - [x] 1부터 9까지 서로 다른 정수
- [x] 사용자로부터 값을 입력받아 적합한지 판단한다.
    - [x] 게임 다시 시작관련 입력
        - [x] 1 혹은 2
    - [x] 게임 진행 관련 입력
        - [x] 3자리 서로 다른 정수
    - [x] 잘못된 값 → `IllegalArgumentException`을 발생시킨다.
- [x] 사용자의 적합한 진행 관련 입력을 정답과 비교한다.
    - [x] 정답이면, 정답임을 알린다.
    - [x] 정답X → 힌트를 출력한다.
        - [x] 같은 수, 같은 자리 → 스트라이크
        - [x] 다른 자리 → 볼
...
- [x] 게임을 관리한다.
    - [x] 게임을 시작한다.
        - [x] 게임의 정답을 생성, 저장한다.
    - [x] 게임을 진행한다.
        - [x] 사용자로부터 값을 받고 비교하는 것을 반복한다.
        - [x] 잘못된 값일 경우 애플리케이션을 종료한다.
        - [x] 정답이면 게임을 종료한다.
    - [x] 게임 종료 후 재시작 여부를 사용자에게 물어본다.
        - [x] 1을 입력하면 게임을 다시 시작한다.
        - [x] 2를 입력하면 게임을 완전 종료한다.
