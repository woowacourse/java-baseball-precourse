...
**1) 입력 기능**
- 사용자가 숫자를 입력한다.
    - [예외] 숫자 이외의 값(공백, 줄바꿈, 문자 등)이 포함되는 경우
    - [예외] 숫자가 세 자리가 아닌 경우
    - [예외] 중복 된 숫자가 입력된 경우
    - [예외] 0이 입력된 경우

- 게임 종료 시, 재시작 여부를 입력한다. (재시작: 1, 종료: 2)
    - [예외] (1) 재시작, (2) 종료 이외의 값을 입력한 경우

**2) 출력 기능**
- 입력한 세 자리 수에 대한 힌트를 출력한다.
- 정답 화면과 함께, 재시작 또는 종료를 물어보는 화면을 출력한다.

**3) 동작 기능**
- 컴퓨터의 난수를 생성한다.
    - 1에서 9사이의 서로 다른 난수 3개

- 컴퓨터의 수와 사용자가 입력한 수를 비교한다.
    - 숫자만 맞고 자리가 다른 경우: "볼"
