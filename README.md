...
- [x] 게임 시작
- [x] 랜덤 숫자 세 개 생성
- [x] 플레이어 입력 요구 스크립트 출력
- [x] 플레이어 문자열 입력
    - [x] 문자열 길이 3 판별
    - [x] 모두 숫자로 이루어져 있는지 판별
    - [x] 0이 없는지 판별
    - [x] 서로 다른 숫자로 이루어져 있는지 판별
- [x] 플레이 입력과 랜덤 숫자 세 개 비교
    - [x] 볼 출력
    - [x] 스트라이크 출력
    - [x] 일치하는 숫자 없을 경우 낫싱 출력
    - [x] 3 스트라이크가 아닐 경우 다시 플레이어 문자열 입력
    - [x] 3 스트라이크일 경우 축하 스크립트 출력
- [x] 게임 종료 경우 플레이어 새로운 게임 플레이 여부 확인
    - [x] 1 입력한 경우 새로운 게임 플레이
    - [x] 2 입력한 경우 프로그램 종료
