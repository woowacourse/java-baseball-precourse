...
## 🤟 구현할 기능 목록
- 임의의 서로 다른 숫자 3개를 지정하기.
- 3자리 수의 입력을 받고 비정상 입력을 처리 : 3자리가 아닌 경우, 숫자가 아닌 경우, 중복 숫자가 입력된 경우.
- 입력받은 숫자를 비교하여 볼과 스트라이크의 갯수를 저장.
- 저장한 갯수를 토대로 힌트 출력, 3스트라이크일 경우 true 반환.
- 입력받은 숫자를 비교하여 볼과 스트라이크의 갯수를 저장.
- 종료 후 1과 2를 입력받아 '다시시작' or '종료' 선택 기능.
- 1과 2 이외의 비정상 입력에 대한 예외처리.
