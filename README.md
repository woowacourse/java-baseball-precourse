...
|No.|기능|확인|
|---|---|:---:|
|1.|컴퓨터 1부터 9까지 서로 다른 3자리수 생성||
|2.|게임 플레이어 숫자 입력 및 잘못된 값을 입력한 경우 에러 발생||
|3.|컴퓨터 입력한 수에 대한 결과 올바르게 표시||
|4.|3개의 숫자를 모두 맞힐때 게임 종료||
|5.|게임을 종료한 후 재시작 및 완전히 종료||
|6.|예시와 동일한 입력과 출력||
...
|7.|DK에서 기본 제공하는 Random, Scanner API 대신 camp.nextstep.edu.missionutils에서 제공하는 Randoms, Console API를 활용해 구현||
|8.|프로그램 구현을 완료했을 때 src/test/java 디렉터리의 ApplicationTest에 있는 모든 테스트 케이스가 성공||
