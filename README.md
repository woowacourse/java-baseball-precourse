...
## ⭐ 기능 명세
#### 야구공
- [x] 공의 숫자가 1부터 9안에 있는 숫자인지
- [x] 공의 숫자가 중복이 되는지
- [x] 공의 개수가 3개를 초과하지 않는지
#### 게임을 참여하는 사람
- 사람
  - [x] 입력한 숫자를 사람이 가지고 있는 리스트로 변경하기
- 컴퓨터
  - [x] 컴퓨터가 가지고 있는 공 리스트 3개 중복 제거 하기

#### 게임을 심판하는 사람
- [x] 공의 위치, 값이 같을 때 - 스트라이크
- [x] 공의 위치는 다르지만, 값이 같을 때 - 볼
- [x] 공의 값이 모두 다른 경우 - 낫싱
