...
- **랜덤값 생성**
    - 1~9의 서로 다른 수로 이루어진 임의의 3자리 수를 랜덤으로 생성


- **사용자에게 3자리 수를 입력받는다.**
    - 입력받은 값이 유효하지 않을 경우, 예외 처리 후 애플리케이션 종료
    - [예외 처리] 3자리 수인지 검사
    - [예외 처리] 3자리가 모두 1~9 수로 이루어져있는지 검사
    - [예외 처리] 3자리 중 중복되는 수가 있는지 검사
...
- **정답 여부 확인**
    - 정답일 경우, 게임 성공
    - 정답이 아닐 경우, 사용자에게 3자리 수를 입력받는 동작부터 반복
   

- **게임 성공 시에 게임 재시작 여부를 입력받는다.**
    - 입력값이 1일 경우, 게임 재시작
    - 입력값이 2일 경우, 애플리케이션 종료
    - [예외 처리] 입력값이 1이나 2인지 검사
