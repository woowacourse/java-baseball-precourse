...
class GameComputerTest {
    ...
    void checkAnswer_ThreeStrike(){
        GameScore gameScore = gameComputer.checkAnswer(new int[]{1, 2, 3});
    ...
    void checkAnswer_OneBall_OneStrike(){
        GameScore gameScore = gameComputer.checkAnswer(new int[]{1, 4, 2});
    ...
    void checkAnswer_ThreeBall(){
        GameScore gameScore = gameComputer.checkAnswer(new int[]{3, 1, 2});
    ...
    void checkAnswer_Nothing(){
        GameScore gameScore = gameComputer.checkAnswer(new int[]{4, 5, 6});
        assertThat(gameScore.getStrike()).isEqualTo(0);
        assertThat(gameScore.getBall()).isEqualTo(0);
    }
