...
class ValidationTest {
    ...
    @Test
    void checkInteger() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> Validation.checkInput("12a"));
        String message = exception.getMessage();
    ...
    @Test
    void checkDuplicate() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> Validation.checkInput("111"));
        String message = exception.getMessage();
