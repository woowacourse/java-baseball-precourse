...
class MarkingManagerTest {
	...
	public void 정답을맞추었을때_Test() throws WrongGuessException {
		...
		Assertions.assertEquals("3스트라이크\n3개의 숫자를 모두 맞히셨습니다! 게임 종료" + System.lineSeparator(), out.toString());
	}
	...
	public void 낫싱print_Test() throws WrongGuessException {
		try {
			...
			Assertions.assertEquals("낫싱" + System.lineSeparator(), out.toString());
		}
	}
	...
	public void 볼print_Test() throws WrongGuessException {
		try {
			...
			Assertions.assertEquals("1볼" + System.lineSeparator(), out.toString());
		}
	}
	...
	public void 스트라이크print_Test() throws WrongGuessException {
		try {
			...
			Assertions.assertEquals("2스트라이크" + System.lineSeparator(), out.toString());
		}
	}
	...
	public void 볼_스트라이크_print_Test() throws WrongGuessException {
		try {
			...
			Assertions.assertEquals("2볼 1스트라이크" + System.lineSeparator(), out.toString());
		}
	}
}