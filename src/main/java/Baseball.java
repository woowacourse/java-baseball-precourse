...
public class Baseball {
  ...
  private static List<Integer> get3() {
  ...
  private static int strikeNum(List<Integer> bN, List<Integer> yN) {
    int strike = 0;
    if (bN.get(0).equals(yN.get(0))) {
      strike++;
    }
    if (bN.get(1).equals(yN.get(1))) {
      strike++;
    }
    if (bN.get(2).equals(yN.get(2))) {
      strike++;
    }
    return strike;
  }

  private static int ballNum(List<Integer> bN, List<Integer> yN) {
    int ball = 0;
    if (bN.get(0).equals(yN.get(1)) || bN.get(0).equals(yN.get(2))) {
      ball++;
    }
    if (bN.get(1).equals(yN.get(0)) || bN.get(1).equals(yN.get(2))) {
      ball++;
    }
    if (bN.get(2).equals(yN.get(0)) || bN.get(2).equals(yN.get(1))) {
      ball++;
    }
    return ball;
  }

  private static boolean tellAns(int s, int b) {
    if (s == 0 && b == 0) {
