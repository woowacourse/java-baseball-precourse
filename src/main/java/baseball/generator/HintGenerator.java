...
public class HintGenerator {
	 ...
	 * @return strikeCount
	 */
	public static int countStrike(ArrayList<Integer> answerNumber,
	 ...
	 * @return ballCount
	 */
	public static int countBall(ArrayList<Integer> answerNumber,
		ArrayList<Integer> playerNumber) {
		...
		return ballCount - countStrike(answerNumber, playerNumber);
	}
}
