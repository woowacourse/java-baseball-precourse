...
public class Const {
	...
	public static final String NEW_GAME_OR_EXIT = "게임을 새로 시작하려면 1, 종료하려면 2를 입력하세요.";

	public static final String SELECT_NEW_GAME = "1";
	public static final String SELECT_EXIT = "2";
}
