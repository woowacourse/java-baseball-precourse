...
public class InputValidator {
    ...
    private static final String NUMBER_EXCEPTION_MESSAGE = "반드시 숫자만 입력해야 합니다.";
    private static final String WRONG_LENGTH_MESSAGE = "세 자리를 입력해야 합니다.";
    private static final String NO_ZERO_MESSAGE = "0이 포함되지 않은 숫자를 입력해야 합니다.";
    private static final String NO_DUPLICATION = "중복된 숫자가 없어야 합니다.";
